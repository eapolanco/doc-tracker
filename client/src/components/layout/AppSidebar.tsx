...
/**
 * AppSidebar - Custom sidebar component for the SaaS dashboard
 *
 * Implements the shadcn/ui Sidebar pattern with:
 * - SidebarHeader: Workspace/brand identity
 * - SidebarContent: Organized navigation groups
 * - SidebarFooter: User profile and actions
 * - Collapsible "icon" variant for space efficiency
 * - "inset" variant for modern framed appearance
 */
